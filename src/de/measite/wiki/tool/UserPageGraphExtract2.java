 ...
 */
public class UserPageGraphExtract2 extends Configured implements Tool {

	/**
	 * @param args
	 */
	public static void main(String[] args) throws Exception {
		int result = ToolRunner.run(new Configuration(), new UserPageGraphExtract2(), args);
		System.exit(result);
	}
	...
	public int run(String[] args) throws Exception {
		...
		if (args.length != 3) {
			System.err.println("Usage: userpagegraph2 <infile> <out> <#outfiles>");
			System.exit(2);
		}
		try {
			Job job = new Job(conf, "userpagegraph2");
			job.setJarByClass(UserPageGraphExtract2.class);
