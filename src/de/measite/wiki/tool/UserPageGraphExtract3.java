 ...
 */
public class UserPageGraphExtract3 extends Configured implements Tool {

	/**
	 * @param args
	 */
	public static void main(String[] args) throws Exception {
		int result = ToolRunner.run(new Configuration(), new UserPageGraphExtract3(), args);
		System.exit(result);
	}
	...
	public int run(String[] args) throws Exception {
		...
		if (args.length != 3) {
			System.err.println("Usage: userpagegraph3 <infile> <out> <#outfiles>");
			System.exit(2);
		}
		try {
			Job job = new Job(conf, "userpagegraph3");
			job.setJarByClass(UserPageGraphExtract3.class);
			job.setCombinerClass(PageRelationByUser.CombinerFunction23.class);
			job.setReducerClass(PageRelationByUser.ReduceFunction2.class);
